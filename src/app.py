...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for soccer matches and improve team skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["lisa@mergington.edu", "kevin@mergington.edu"]
    },
    "Basketball Club": {    
        "description": "Practice basketball drills and compete in local games",
    ...
    "Science Olympiad": {
        "description": "Compete in science quizzes and lab challenges",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "zoe@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and participate in debate competitions",
